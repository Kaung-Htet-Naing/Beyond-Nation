...
function thanlwinLoaded() {
  ...
  if (
    contentsBar &&
    typeof myKeyboardMover != "undefined" &&
...
myUnsupported =
  '<p class="myWarning">Your Web Browser does not support Myanmar Unicode, please see <a href="/ThanLwinSoft/MyanmarUnicode/WebDevelopers/#detect">here</a> to get a browser with Myanmar Unicode Support.</p>';
